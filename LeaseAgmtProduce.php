...
function myDebug()
{
	return false;
		...
		echo '
			<form action="LeaseAgmtProduce.php" method="post">
				Doc name: <input type="text" name="doc_name" value="LeaseAgmtBuilder"><br>
...
$getFieldLCarray = array ( "petitioner_company_name"=>"Velie Law Firm", "L_Int_Company"=>"Hunt Corporation", "L_State_Incorp_IC"=>"Norman", "Lease_Address"=>"367 W Main St # 308, Norman, OK 73069", "Lease_Area"=>"420", "Lessee_Name"=>"Ben Hunt", "Lease_Start"=>"1 Jan, 2017", "Lease_End"=>"1 Jan, 2019", "Total_Sum"=>"13000.00", "Installment_Sum"=>"1360.50" );
