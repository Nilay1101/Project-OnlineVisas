...
function myDebug()
{
	return false;
		...
		echo '
			<form action="IntlEmplymentL1AProduce.php" method="post">
				Doc name: <input type="text" name="doc_name" value="IntlEmploymentL1ABuilder"><br>
...
$getFieldLCarray = array ( "petitioner_company_name"=>"Online Visas", "beneficiary_name_first"=>"Nilay", "beneficiary_name_last"=>"Jayswal", "Intl_employment_letter_signator"=>"Ania Steel", "Title_Intl_employment_letter_signator"=>"Senior Human Resource Manager", "L_Int_Company"=>"Grey Industries", "L_Place_Incorp_IC"=>"Washington DC", "L_State_Incorp_USC"=>"Norman", "L_Beneficiary_IC_Position"=>"Marketing Executive", "L_Beneficiary_Start_Date_IC"=>"January 1, 2017", "L_Beneficiary_work_venue_IC"=>"New Delhi, India", "L_Category_Duty_IC_1"=>"Duty Summary1", "L_Category_Duty_IC_2"=>"Duty Summary2", "L_Category_Duty_IC_3"=>"Duty Summary3", "beneficiary_title"=>"Mr." );
