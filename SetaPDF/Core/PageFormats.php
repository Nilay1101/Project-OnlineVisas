 ...
 * @version    $Id: PageFormats.php 1031 2017-03-17 07:06:12Z timo.scholz $
 */
...
class SetaPDF_Core_PageFormats
{
    ...
    {
        $format = self::getFormat($format, self::ORIENTATION_AUTO);
        ...
        $rect = self::getFormat($rect, self::ORIENTATION_AUTO);
