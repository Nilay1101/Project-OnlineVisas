 ...
 * @version    $Id: Fields.php 1031 2017-03-17 07:06:12Z timo.scholz $
 */
...
class SetaPDF_FormFiller_Fields implements Countable, Iterator, ArrayAccess
{
     ...
     * @return bool Wether the cached instance was removed or not.
     */
    ...
    public function delete($field = null)
    {
        if (null === $field) {
            ...
            $this->getFormFiller()->getAcroForm()->removeXfaInformation();
