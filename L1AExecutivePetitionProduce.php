...
function myDebug()
{
	return false;
		...
		echo '
			<form action="L1AExecutivePetitionProduce.php" method="post">
				Doc name: <input type="text" name="doc_name" value="L1AExecutivePetitionBuilder"><br>
...
$getFieldLCarray = array ( "Visa_Type"=>"L1A", "position_title"=>"Junior Developer", "petitioner_company_name"=>"Online Visas", "beneficiary_title"=>"Mr.",
"beneficiary_first_name"=>"Nilay", "beneficiary_last_name"=>"Jayswal", "beneficiary_citizenship_country"=>"India", "L_Int_Company"=>"International Company ABC",
"L_US_Company"=>"US Company ABC", "L_Beneficiary_US_Position"=>"US Position", "Companies_Relationship"=>"Business Partners", "L_Beneficiary_IC_Position"=>"IC Position", "L_Beneficiary_work_venue_IC"=>"IC Work Venue", "L_Beneficiary_Start_Date_IC"=>"January 1, 2017", "L_Category_Duty_IC_1"=>"Duty Summary IC 1", "L_Category_Duty_IC_2"=>"Duty Summary IC 2", "L_Category_Duty_IC_3"=>"Duty Summary IC 3", "L_Category_Duty_USC_1"=>"Duty Summary USC 1", "L_Category_Duty_USC_2"=>"Duty Summary USC 2", 
"L_Category_Duty_USC_3"=>"Duty Summary USC 3", "L_Beneficiary_term_employment"=>"36 Months 24 Days", "L_Beneficiary_Salary"=>"$ 130000 p.a.", 
"L_Describe_Intl_Company"=>"Description of International Company", "L_Place_Incorp_IC"=>"Washington DC", "L_IC_Date_Incorp"=>"1893", "L_IC_Ownership"=>"IC Ownership",
"L_IC_Employees"=>"IC Employees", "L_IC_Revenues"=>"IC Revenues", "L_IC_Assets"=>"IC Assets", "L_Describe_US_Company"=>"Description of US Company","L_State_Incorp_USC"=>"Norman", "L_Date_Incorp_USC"=>"1993", "L_USC_Ownership"=>"USC Ownership", "L_USC_Employees"=>"USC Employees", "L_USC_Revenues"=>"USC Revenues", "L_USC_Assets"=>"USC Assets", 
"Target_Market"=>"Target Market details, properties, agreements will be listed here", "L_Holding_Company_Description"=>"Description of Holding Company", 
"petitioner_primary_contact"=>"Mrs Ania Steel", "Service_Center_Address"=>"Washington DC" 	);
